...
figlet Mr.Second🐉  | lolcat

echo "_____________________________________________________________"
echo "Tools    : hacker tools                         " |lolcat
echo "Creadby  : Mr.SecondGans🐉                                      " |lolcat
echo "Contact  : 0895634386094                              " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : Mr.secondGans🐉" | lolcat
exit
;;
